...
glafic.init(0.3089, 0.6910, -1.0, 0.6736, 'Lens Models/pow_shear_pos+flux', -1, -0.4, 0.4, 1.0, 0.001, 0.001, 1, verb = 0)
...
glafic.set_lens(1, 'pow', 0.5, 2.2245, -0.3, 0.4, 0.5, 0, 0.446, 2.0)
...
glafic.setopt_lens(2, 1, 0, 0, 0, 1, 1, 0, 0)
